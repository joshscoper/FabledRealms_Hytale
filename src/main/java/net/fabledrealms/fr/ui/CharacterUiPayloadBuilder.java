...
public final class CharacterUiPayloadBuilder {
    ...
    public String build(String playerName, List<CharacterSummary> roster) {
        ...
        sb.append("{\"schema\":1,")
                .append("\"type\":\"fabledrealms.character.menu\",")
                .append("\"player\":\"").append(escape(playerName)).append("\",")
                .append("\"actions\":{")
                .append("\"create\":\"/charcreate <name>\",")
                .append("\"select\":\"/charselect <index>\",")
                .append("\"delete\":\"/chardelete <index>\"},")
                .append("\"characters\":[");
